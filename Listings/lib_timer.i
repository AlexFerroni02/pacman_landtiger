...
void enable_timer( uint8_t timer_num )
{
 ...
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = 1;
  ...
  {
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 1; //start count the timer
  }
 else if(timer_num == 2){
...
// <i> 0 Feature disabled.
// </e>
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR = 3;// we want interrupt and reset
// </h>
// <<< end of configuration section >>>
 ...
 __NVIC_SetPriority(TIMER1_IRQn, 3);
