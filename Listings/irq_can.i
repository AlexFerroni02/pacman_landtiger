...
void CAN_IRQHandler (void) {
 ...
 if (icr & (1 << 0)) {
  ...
  if(countdownd != new_countdown){
   ...
   GUI_Text(110, 10, (uint8_t *)str3, 0xFFFF, 0x0000);
  }
  ...
  GUI_Text(200, 10, (uint8_t *)str, 0xFFFF, 0x0000);
  }
