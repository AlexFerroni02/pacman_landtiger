...
BOOL isNotePlaying(void) {
    return ((((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR != 0) ); // Controlla se i timer sono attivi cioe se tim2 e spento e perche e stato disattivato dal timer 3 quindi la nota e finita
}
