...
void RIT_IRQHandler (void)
{
 ...
 if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1<<29)) == 0) {
  ...
  if(down>=1){
   if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<10)) == 0){ //EINT 0 pressed
    char str2[10];
    ...
    switch (down){
     ...
     case 2: // we have the action at the first pressed we start the game, at the second we stop it
      if(pause ==1 ){ // we have to start for the start we have to activate the timer and disactivate it
       pause =0;
       char str3[10] = "     ";
       GUI_Text(100, 190, (uint8_t *)str3, 0x0000, 0x0000);
       ...
       pause =1;
       char str3[10] = "PAUSE";
       GUI_Text(100, 190, (uint8_t *)str3, 0xFFFF, 0x0000);
